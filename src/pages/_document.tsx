  ...
  return (
    <Html lang="ko">
      <Head>
        ...
        <meta
          name="description"
          content="원두, 디저트 등 다양한 카페재료를 최저가 견적으로 손쉽게 구입할 수 있는 카페매니저입니다. 카페사장님을 위한 다양한 혜택을 무료로 받아가세요"
        />
        <meta
          name="keywords"
          content="카페원두, 원두, 디저트, 시럽, 원두납품, 원두도매, 카페재료, 카페시럽, 디저트납품, 카페우유, 카페원두납품, 디저트레시피, 카페창업, 사업자원두, 업소용원두, 개인카페창업, 카페, 베이커리납품, 소자본카페"
        />
        ...
        <meta
          ...
          content="iY8MNvrBwCorFcJBU8-rfiSpSssR4gfTfofiaFDcoUY"
        />
      </Head>
      <body>
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-KQH4F6C7LQ"
          strategy="afterInteractive"
          async
        />
        <Script
